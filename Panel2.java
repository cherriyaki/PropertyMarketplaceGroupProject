...
/**
 * This is the GUI of the second panel - the map that shows filtered
 * data of houses available according to price.
 */
...
public class Panel2
{
    ...
    public Panel2(PanelControl panelControl) {
        ...
        panel2.getStylesheets().add("panel2.css");
    }
    ...
    /**
     * creates the button for the map and colours them in according to tier
     */
